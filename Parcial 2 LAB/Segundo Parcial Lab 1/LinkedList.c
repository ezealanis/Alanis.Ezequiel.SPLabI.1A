    ...
    if(this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
    {
        ...
        if(nodoNuevo != NULL)
        {
            ...
            else
            {
                ...
                getNode(this, nodeIndex-1)->pNextNode = nodoNuevo;
            }
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        nodoAux = (Node*) getNode(this, index);
        ...
        if(nodoAux != NULL)
        {
            ...
            {
                nodoAnt = (Node*) getNode(this, index -1);
                if(nodoAnt != NULL)
                {
    ...
    if(this != NULL && pFunc != NULL &&(order == 1 || order == 0))
    {
        ...
        for(int i = 0; i < tam - 1; i++)
        {
            for(int j = i + 1; j < tam; j++)
            {
                ...
                if( (order == 1 && pFunc(elemento1, elemento2) > 0) || (order == 0 && pFunc(elemento1, elemento2) < 0) )
                {
                    aux = elemento1;
 ...
 * \param Funcion que filtra el elemento, devuelve 1 si el elemento es devuelto en la lista o 0 si no.
